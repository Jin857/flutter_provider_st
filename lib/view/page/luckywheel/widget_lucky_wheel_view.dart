...
import 'package:flutter_provider_st/view/page/luckywheel/component/custom_lucky_darw_paint.dart';
import 'package:flutter_provider_st/view/page/luckywheel/component/custom_pointer.dart';
...
openWidgetLuckyWheel(BuildContext context) async {
  showDialog(
    context: context,
    builder: (a) {
      return WidgetLuckyWheelView();
    },
  );
}

class WidgetLuckyWheelView extends StatelessWidget {
  WidgetLuckyWheelView({super.key});
